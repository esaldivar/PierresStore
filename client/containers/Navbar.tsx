...
const NavBar = () => {
	return (
		<div className="navBar">
			...
			<div>
				<input className="navSearch" type="search" name="search" placeholder="Search Pierre's Store" title="Search Stardew Valley Wiki [ctrl-option-f]"  id="searchInput" autoComplete="off"/>
			</div>
			<div>
